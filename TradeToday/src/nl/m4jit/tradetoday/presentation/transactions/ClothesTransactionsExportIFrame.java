...
import nl.m4jit.tradetoday.domainlogic.transactions.InTransactionsExportModel;
import org.jdesktop.swingx.JXMonthView;

public class ClothesTransactionsExportIFrame extends OkCancelDialog{
    
    private JXMonthView startDateMV, endDateMV;
    
    public ClothesTransactionsExportIFrame(){
    ...
    public void ok() {
        ...
        if (returnval == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                List<TransactionruleGateway> rules = TransactionruleTable.getInstance().findInsByTimePeriod(startDate, endDate);
                writer.addTableSheet(new InTransactionsExportModel(rules), "Inname transacties");
